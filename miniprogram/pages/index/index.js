...
Page({
  ...
  onImageLoad: function (e) {
    ...
    let dataheight = this.data.imgHeight ;
    let scale = dataheight / oImgH;        //比例计算
    let imgHeight = oImgH * scale;      //自适应高度
    let setwidth = oImgW * scale;
    ...
    imageObj.height = dataheight;
    imageObj.width = setwidth;
